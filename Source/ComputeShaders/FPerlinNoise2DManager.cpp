...
#include "FPerlinNoise2DManager.h"
...
/// </summary>
class FPerlinNoise2D : public FGlobalShader
{
public:
	//Declare this class as a global shader
	DECLARE_GLOBAL_SHADER(FPerlinNoise2D);
	//Tells the engine that this shader uses a structure for its parameters
	SHADER_USE_PARAMETER_STRUCT(FPerlinNoise2D, FGlobalShader);
	/// <summary>
...
IMPLEMENT_GLOBAL_SHADER(FPerlinNoise2D, "/CustomShaders/WhiteNoiseCS.usf", "MainComputeShader", SF_Compute);

//Static members
FPerlinNoise2DManager* FPerlinNoise2DManager::instance = nullptr;

//Begin the execution of the compute shader each frame
void FPerlinNoise2DManager::BeginRendering()
{
	...
	if (RendererModule)
	{
		OnPostResolvedSceneColorHandle = RendererModule->GetResolvedSceneColorCallbacks().AddRaw(this, &FPerlinNoise2DManager::Execute_RenderThread);
	}
}

//Stop the compute shader execution
void FPerlinNoise2DManager::EndRendering()
{
...
void FPerlinNoise2DManager::UpdateParameters(FPerlinNoise2DParameters& params)
{
	cachedParams = params;
...
/// </summary>
void FPerlinNoise2DManager::Execute_RenderThread(FRHICommandListImmediate& RHICmdList, class FSceneRenderTargets& SceneContext)
{
	...
	FPerlinNoise2D::FParameters PassParameters;
	...
	TShaderMapRef<FPerlinNoise2D> whiteNoiseCS(GetGlobalShaderMap(GMaxRHIFeatureLevel));
